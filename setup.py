...
setup(
    ...
    author_email='ivan.eichhardt@sztaki.hu',
    description='python bindings for OneAC pose estimation',
    long_description='',
    packages=find_packages('src/Samples'),
    package_dir={'':'src/Samples'},
    ext_modules=[CMakeExtension('pyoneacpose/pyoneacpose')],
